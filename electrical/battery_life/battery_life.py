...
def rev_D3():
    ...
    files = ["Rev_D3_Duracell_add_spacer_change_tuning.csv","Rev_D3_Energizer_Max_add_spacer_change_tunings.csv","Rev_D3_Enegizer_Prevent_Doublepush.csv","Rev_D3_Duracel_Prevent_Doublepush.csv","Rev_D4_Duracel_Add_Cap.csv"]
